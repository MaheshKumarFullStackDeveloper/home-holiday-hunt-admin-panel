    ...
    <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <form id="addAgent" method="post"  action="{{ route('save_delivery_agent') }}" onload="resetForm()" autocomplete="off" enctype="multipart/form-data">
              @csrf
               
              <div class="row mx-0">
                <input type="hidden" name="is_available" class="form-control"  value="1" >
                <input type="hidden" name="is_locked" class="form-control" value="0" > 
          ...
          $('#addAgent').validate({
            ...
            rules: {
              ...
              email:{
                ...
                remote:{
                  type:"post",
                  url:"{{route('checkdelivery.agent.email')}}",
                  data: {
