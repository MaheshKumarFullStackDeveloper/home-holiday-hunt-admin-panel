      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               ...
               @endif
               <form id="editInterestForm" autocomplete="off" method="post", action="{{ route('update_interest') }}" onload="myFunction()"  enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">

                     <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
                        <div class="profile-image-show mt-3">
                           <a href="javascript:;" class="remove-pro-img {{ $editInterest->image!=null ? '':'d-none' }}" id="{{ $editInterest->id ?? '' }}" style="display:block">
                           ...
                           <img src="{{ URL::asset('images/interest_images/'.$editInterest->image) }}" class="{{ $editInterest->image!=null ? '':'d-none' }}" width="80%" id="profileImage">
                           <div class="thumb_nails {{ $editInterest->image!=null ? 'd-none':'' }}">
                           ...
                           <input type="file"  accept="image/*" name="profile_picture" id="profile_picture" class="{{ $editInterest->image!=null ? 'd-none':'' }}">  
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              <input type="hidden" name="interest_id" value="{{ $editInterest->id}}">
                              <label for="name">Name<span class="text-danger"> *</span></label>
                              <input type="text" name="name" value="{{ $editInterest->name}}" class="form-control" id="name" maxlength="100">
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" name="slug" value="{{ $editInterest->slug}}" class="form-control" id="slug" maxlength="100" disabled>
                           </div>
                        </div>
                     </div>
                      <div class="row">
                        <div class="col-md-12">
                           ...
                           <select class="form-control" name="category">
                              <option value="">Select category</option>
                               @forelse ($interestcategory as $cat1)
                        <option  {{ $editInterest->interest_category_id == $cat1->id ? 'selected' : ' ' }}    value="{{ $cat1->id }}">{{ $cat1->name }}</option>
                    @empty
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#editInterestForm').validate({
        ...
        messages: {
         name: {
           required: " The Interest is required",
          },
         profile_picture :{
           required: "Interest Picture required"
         },
         category: {
