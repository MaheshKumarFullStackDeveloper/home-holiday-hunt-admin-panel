      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               ...
               @endif
               <form id="addInterestForm" autocomplete="off" method="post", action="{{ route('save_interest') }}" onload="myFunction()"  enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" name="slug" value="" class="form-control" id="slug" maxlength="100" disabled>
                           </div>
                        </div>
                     </div>
                     <div class="row">
...
if (json.msg == 1) {
return "\"" + "Interest is already  exist" + "\"";
} else {
return 'true';
}
}    
