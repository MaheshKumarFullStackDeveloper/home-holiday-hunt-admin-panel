      ...
      <div class="col-md-12">
         <div class="card">
            <div class="card-header alert d-flex justify-content-between align-items-center">
               ...
               @can('view_marketing_user')
               <a class="btn btn-sm btn-success" href="{{route('marketting.add_user')}}"><i class="fas fa-plus-circle mr-2"></i>Add New</a> 
               @endcan
            </div>
            <div class="card-body">
               @if (session('status'))
               ...
               <table style="width:100%" id="users-list" class="table table-bordered table-hover yajra-datatable">
                  <thead>
                     <tr>
                        ...
                        <th>Status</th>
                          @can('manage_marketing_user_action')
                        <th>Actions</th>
                        @endcan
                     </tr>
                  </thead>
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <span class="badge badge-pill badge-success p-1 px-2" style="letter-spacing:1px;">Verified User</span>
                           @else
                           <span class="badge badge-pill badge-danger p-1 px-2" style="letter-spacing:1px;">Not Verified User</span>
                           @endif
                        </td>
                         @can('manage_marketing_user_action') 
                        <td>
...
if (willDelete) {
$.ajax({
url: "{{ route('marketting.delete_user') }}",
type: 'post',
data: {
"_token": "{{ csrf_token() }}",
id: id
