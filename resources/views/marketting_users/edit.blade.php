      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               ...
               @endif
               <form class="user_edit_form" method="POST" action="{{ route('marketting.update_user') }}" enctype='multipart/form-data'>
                  <input class="form-control" type="hidden"  value="{{ $editUser->id }}" name="user_id" >
                  <div class="row">
                     <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
                        <div class="profile-image-show mt-3">
                           <a href="javascript:;" class="remove-pro-img {{ $editUser->profile_picture!=null ? '':'d-none' }}" id="{{ $editUser->id ?? '' }}" style="display:block">
                           ...
                           <img src="{{ $editUser->profile_picture }}" class="{{ $editUser->profile_picture!=null ? '':'d-none' }}" width="80%" id="profileImage">
                           <div class="thumb_nails {{ $editUser->profile_picture!=null ? 'd-none':'' }}">
                           ...
                           <input type="file"  accept="image/*" name="profile_picture" id="profile_picture" class="{{ $editUser->profile_picture!=null ? 'd-none':'' }}">  
                        </div>
                     </div>
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           <label>First Name <span class="text-danger"> *</span></label>
                           <input type="text" class="form-control" maxlength="20"  value="{{ $editUser->first_name }}" name="first_name" >
                        </div>
                     </div>
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           <label>Last Name</label>
                           <input type="text" class="form-control" maxlength="20"  value="{{ $editUser->last_name }}" name="last_name" >
                        </div>
                     </div>
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                     ...
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           ...
                           <br>
                           <input type="tel"  name="phone_number" class="form-control"  id="txtPhone"  autocomplete="false" value="{{ $editUser->phone_number ?? '' }}" />
                           <input type="hidden"  name="country_code" class="form-control"  id="country_code" value="{{ $editUser->country_code ?? '' }}" /> 
                        </div>
                     </div>
                     ...
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           ...
                           <select class="form-control"  name="gender">
                              ...
                              <option {{ $editUser->gender == 1 ? 'selected' : ' ' }} value="1">Male</option>
                              <option {{ $editUser->gender == 2 ? 'selected' : ' ' }} value="2">Female</option>
                              <option {{ $editUser->gender == 3 ? 'selected' : ' ' }} value="3">Transgender</option>
                           </select>
                        </div>
                     </div>
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="preferred_lang">
                              ...
                              <option {{ $editUser->preferred_lang == 1 ? 'selected' : ' ' }}  value="1">English</option>
                              <option {{ $editUser->preferred_lang == 2 ? 'selected' : ' ' }}  value="2">Spanish</option>
                              <option {{ $editUser->preferred_lang == 3 ? 'selected' : ' ' }}  value="3" >Chinesh</option>
                              <option {{ $editUser->preferred_lang == 4 ? 'selected' : ' ' }}  value="4">Portuguese</option>
                              <option {{ $editUser->preferred_lang == 5 ? 'selected' : ' ' }}  value="5">Arbic</option>
                              <option {{ $editUser->preferred_lang == 6 ? 'selected' : ' ' }}   value="6">Hindi</option>
                           </select>
                        </div>
                     </div>
                  </div>
...
<script type="text/javascript">
  $(function () {
      var code = "+"+"{{ $editUser->country_code}}{{ $editUser->phone_number}}"; // Assigning value from model.
      $('#txtPhone').val(code);
