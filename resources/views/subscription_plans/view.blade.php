            ...
            <div class="row">
               <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
                      <div class="profile-image-show mt-3">
                        <a href="javascript:;" class="remove-pro-img {{ $users->profile_picture!=null ? '':'d-none' }}" id="{{ $users->id ?? '' }}" style="display:block">
                   
                         </a>
                     
                        <img src="{{ $users->profile_picture }}" class="{{ $users->profile_picture!=null ? '':'d-none' }}" width="80%" id="profileImage">
                        ...
                        <div class="thumb_nails {{ $users->profile_picture!=null ? 'd-none':'' }}">
                          ...
                          <input type="file"  accept="image/*" name="profile_picture" id="profile_picture" class="{{ $users->profile_picture!=null ? 'd-none':'' }}">  
                      </div>
                </div>  
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <br>
                    <input type="tel"  name="phone_number" class="form-control"  id="txtPhone"  autocomplete="false" value="{{ $users->phone_number ?? '' }}" readonly />
                    <input type="hidden"  name="country_code" class="form-control"  id="country_code" value="{{ $users->country_code ?? '' }}" readonly /> 
                  </div>
                </div>
                   ...
                   <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" value="{!! date('Y/m/d', strtotime($users->dob)) !!}" name="dob"  readonly >
                        </div>
                     </div> 
                        ...
                        <div class="form-group">
                           <label>Gender</label>
                            ...
                            <select class="form-control"  name="gender" disabled>
                              ...
                              <option {{ $users->gender == 3 ? 'selected' : ' ' }} value="3">Transgender</option>
                             </select> 
                        ...
                        <div class="form-group">
                           <label>Preferred Language</label>
                            ...
                            <select class="form-control" name="preferred_lang" disabled>
                              ...
                              <option {{ $users->preferred_lang == 1 ? 'selected' : ' ' }}  value="1">English</option>
                              <option {{ $users->preferred_lang == 2 ? 'selected' : ' ' }}  value="2">Spanish</option>
                              <option {{ $users->preferred_lang == 3 ? 'selected' : ' ' }}  value="3" >Chinesh</option>
                              <option {{ $users->preferred_lang == 4 ? 'selected' : ' ' }}  value="4">Portuguese</option>
                              <option {{ $users->preferred_lang == 5 ? 'selected' : ' ' }}  value="5">Arbic</option>
                              <option {{ $users->preferred_lang == 6 ? 'selected' : ' ' }}   value="6">Hindi</option>
                        ...
                        <div class="form-group">
                           <label>Ethicity</label>
                            ...
                            <select class="form-control" name="ethinicity" disabled>
                              ...
                              <option value="1" {{ $users->ethinicity == 1 ? 'selected' : ' ' }}>White</option>
                              <option value="2" {{ $users->ethinicity == 2 ? 'selected' : ' ' }}>Black</option>
                              <option value="3" {{ $users->ethinicity == 3 ? 'selected' : ' ' }}>Asia</option>
                              <option value="4" {{ $users->ethinicity == 4 ? 'selected' : ' ' }}>Amerindian/Alaska(native)</option>
                              <option value="5" {{ $users->ethinicity == 5 ? 'selected' : ' ' }}>Hawaiian/Pacific Islander(native)</option>
                              <option value="6" {{ $users->ethinicity == 6 ? 'selected' : ' ' }}>Mixed ethnicit</option> 
                        ...
                        <div class="form-group">
                           <label>Sexual Orientation</label>
                            ...
                            <select class="form-control" name="sexual_orientation" disabled>
                              ...
                              <option value="1" {{ $users->sexual_orientation == 1 ? 'selected' : ' ' }}>Straight</option>
                              <option value="2" {{ $users->sexual_orientation == 2 ? 'selected' : ' ' }}>Gay</option>
                              <option value="3"  {{ $users->sexual_orientation == 3 ? 'selected' : ' ' }}>Lesbian</option>
                              <option value="4" {{ $users->sexual_orientation == 4 ? 'selected' : ' ' }}>Bisexual</option>
                        ...
                        <div class="form-group">
                           <label>Skin Color</label>
                            ...
                            <select class="form-control" name="skin_color" disabled>
                              ...
                              <option value="1" {{ $users->skin_color == 1 ? 'selected' : ' ' }}>Extremely fair skin</option>
                              <option value="2" {{ $users->skin_color == 2 ? 'selected' : ' ' }}>Fair Skin</option>
                              <option value="3" {{ $users->skin_color == 3 ? 'selected' : ' ' }}>Medium Skin</option>
                              <option value="4" {{ $users->skin_color == 4 ? 'selected' : ' ' }}>Olive Skin</option>
                              <option value="5" {{ $users->skin_color == 5 ? 'selected' : ' ' }}>Brown Skin</option>
                              <option value="6" {{ $users->skin_color == 6 ? 'selected' : ' ' }}>Black Skin</option>
                        ...
                        <div class="form-group">
                           <label>Body Type</label>
                            ...
                            <select class="form-control" name="body_type" disabled>
                              ...
                              <option value="1" {{ $users->body_type == 1 ? 'selected' : ' ' }}>Endomorph</option>
                              <option value="2" {{ $users->body_type == 2 ? 'selected' : ' ' }}>Mesomorph</option>
                              <option value="3" {{ $users->body_type == 3 ? 'selected' : ' ' }}>Ectomorph</option>
                      ...
                      <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           ...
                           <input type="number" class="form-control" maxlength="20"  value="{{ $users->height ?? '' }}" name="height" min="1" readonly>
                        </div>
                     </div>
                      ...
                      <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           ...
                           <input type="number" class="form-control" maxlength="20"  value="{{ $users->weight ?? '' }}" name="weight" min="1" readonly>
                        </div>
                     </div>
                     ...
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           <label>Bio</label>
                           <div   name="bio" maxlength="200" style="overflow: auto;border: 1px solid #d9d9d9 ;border-radius:14px;padding:5px 5px ;">{{$users->bio}}</div>
                        </div>
                     </div>
