      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               ...
               @endif
               <form id="addPlan" method="post"  action="{{route('subscription-plan.update_plans')}}" onload="resetForm()" autocomplete="off" enctype="multipart/form-data">
                  <input type="hidden" value="{{ $editPlan->id}}" name="plan_id">
                  @csrf
                  <div class="row mx-0">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <input type="text" name="plan_name" class="form-control" id="plan_name" value="{{ $editPlan->plan_name }}">
                        </div>
                     </div>
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <select class="form-select form-control" aria-label="Default select example" name="plan_duration" id="plan_duration">
                             ...
                             <option value="1" {{ $editPlan->plan_duration==1 ? 'selected':'' }}>1 Month</option>
                             <option value="2" {{ $editPlan->plan_duration==2 ? 'selected':'' }}>2 Month</option>
                             <option value="3" {{ $editPlan->plan_duration==3 ? 'selected':'' }}>3 Month</option>
                             <option value="4" {{ $editPlan->plan_duration==4 ? 'selected':'' }}>4 Month</option>
                             <option value="5" {{ $editPlan->plan_duration==5 ? 'selected':'' }}>5 Month</option>
                             <option value="6" {{ $editPlan->plan_duration==6 ? 'selected':'' }}>6 Month</option>
                             <option value="7" {{ $editPlan->plan_duration==7 ? 'selected':'' }}>7 Month</option>
                             <option value="8" {{ $editPlan->plan_duration==8 ? 'selected':'' }}>8 Month</option>
                             <option value="9" {{ $editPlan->plan_duration==9 ? 'selected':'' }}>9 Month</option>
                             <option value="10" {{ $editPlan->plan_duration==10 ? 'selected':'' }}>10 Month</option>
                             <option value="11" {{ $editPlan->plan_duration==11 ? 'selected':'' }}>11 Month</option>
                             <option value="12" {{ $editPlan->plan_duration==12 ? 'selected':'' }}>12 Month</option>
                           </select>               
                        </div>
                     </div>
                      <div class="col-6">
                        <div class="form-group">
                           ...
                           <br>
                           <input type="text"  name="plan_price" class="form-control"  id="planPrice"  autocomplete="false" value="{{ $editPlan->plan_price }}"/>
