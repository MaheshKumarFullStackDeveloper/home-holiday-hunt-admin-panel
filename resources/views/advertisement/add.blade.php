      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               ...
               @endif
               <form id="addAdvertisementForm" autocomplete="off" method="post" action="{{ route('advertisement.save') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                      <div class="row">
                        <div class="col-md-12">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" name="adv_txt" class="form-control" id="adv_txt" maxlength="100" value="">
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="url" name="adv_url" class="form-control" id="adv_url" maxlength="100">
                           </div>
                        </div>
                     </div>
