      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               ...
               @endif
               <form id="updateAdvertisementForm" autocomplete="off" method="post" action="{{ route('advertisement.update') }}" enctype="multipart/form-data">
                 <input type="hidden" name="id" class="form-control" id="id" value="{{ $advertisement->id ?? ''}}">
                  @csrf
                  <div class="card-body">
                    <div class="row">
                         <div class="col-md-12">
                           ...
                           <input type="file" accept="image/*" name="adv_image" id="profile_picture" class="" autocomplete="new-password">  
                        </div>
                    <!--           <input type="file" name="adv_image" class="form-control" id="adv_image"> -->
                           </div>
                        </div>
                        <!-- <div class="col-md-12">
                           <div class="form-group">
                              <label for="name">Advertisement Image<span class="text-danger"> *</span></label>
                                 <img src="{{ $advertisement->adv_image ?? ''}}" height="150" width="150">
                              <input type="file" name="adv_image" class="form-control" id="adv_image" value="{{ $advertisement->adv_image ?? ''}}">
                           </div>
                        </div> -->
                     </div>
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              <label for="name">Advertisement Text<span class="text-danger"> *</span></label>
                              <input type="text" name="adv_txt" class="form-control" id="adv_txt" maxlength="100" value="{{ $advertisement->adv_txt ?? ''}}">
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              <label for="name">Advertisement Action URL<span class="text-danger"> *</span></label>
                              <input type="url" name="adv_url" class="form-control" id="adv_url" value="{{ $advertisement->adv_action_url ?? ''}}">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              <label for="name">Advertisement Area (Select where you want show the add)<span class="text-danger"> *</span></label>
                              <select name="adv_area" id="adv_area" class="form-control">
                                  <option value=""  selected disabled>--Select Advertisent Area--</option>
                                 @foreach(adv_area() as $key=>$area)
                                      <option value="{{ $key }}" {{ $advertisement->adv_show_area==$key ? 'selected':''}}>{{ $area }}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              <label for="name">Advertisement Slot (Select when you want to start the advertisement)<span class="text-danger"> *</span></label>
                              <select name="timeslot" id="timeslot" class="form-control">
                                 <option value="" selected disabled>--Select Advertisent Slot--</option>
                                 @foreach(adv_timeslot() as $key=>$timeslot)
                                      <option value="{{ $key }}" {{ $advertisement->adv_show_btw==$key ? 'selected':''}}>{{ $timeslot }}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
...
$('#updateAdvertisementForm').validate({
   ...
   messages: {
      adv_txt: {
         required: "Advertisment text is required",
      },
      adv_url: {
         required: "Advertisement action url is required",
      ...
      adv_area: {
         required: "Advertisement area is required"
      },
      timeslot: {
         required: "Advertisement slot is required"
      },
   }
   });
