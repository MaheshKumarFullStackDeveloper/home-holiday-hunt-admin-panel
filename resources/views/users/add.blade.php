...
<div class="container px-1">
      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               ...
               @endif
               <form id="addUser" method="post" class="dropzone"   onload="resetForm()" autocomplete="off" enctype="multipart/form-data" name="demoform" style="border:none;">
                  @csrf
                   <input type="hidden" class="userid" name="userid" id="userid"  value="" >
                      <input type="hidden" class="temp_token" name="temp_token" id="temp_token"  value="" >
                  <div class="row mx-0">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           <label>Ethinicity<span class="text-danger"> *</span> </label>
                           <select class="form-control" name="ethinicity">
                              <option value="">Select Ethnicity</option>
                              @forelse ($ethnicity as $ethnicity)
                        <option value="{{ $ethnicity->id }}">{{ $ethnicity->name }}</option>
                     @empty
                         <option>No ethnicity  </option>
                     @endforelse
                           </select>
                        </div>
                     </div>
                     ...
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           <label>Sexual Orientation <span class="text-danger"> *</span></label>
                     ...
                     <!-- <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12 d-none">
                        <div class="form-group">
                           <label>Skin Color <span class="text-danger"> *</span></label>
                           <select class="form-control" name="skin_color">
                              <option value="">Select Skin Color</option>
                              <option value="1"  >Extremely fair skin</option>
                              <option value="2"  >Fair Skin</option>
                              <option value="3"  >Medium Skin</option>
                              <option value="4"  >Olive Skin</option>
                              <option value="5"  >Brown Skin</option>
                              <option value="6"  >Black Skin</option>
                           </select>
                        </div>
                     </div>
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12 d-none">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="body_type">
                              ...
                              <option value="3"  >Ectomorph</option>
                           </select>
                        </div>
                     </div>
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12 d-none">
                        <div class="form-group">
                           <label>Height (in CM) <span class="text-danger"> *</span> </label>
                           <input type="number" class="form-control" maxlength="20"    name="height" min="1" onKeyPress="if(this.value.length==3) return false;">
                        </div>
                     </div>
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12 d-none">
                        <div class="form-group">
                           <label>Weight (in Kg) <span class="text-danger"> *</span> </label>
                           <input type="number" class="form-control" maxlength="20"    name="weight" min="1" onKeyPress="if(this.value.length==3) return false;" >
                        </div>
                     </div> -->
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           <label>Bio <span class="text-danger"> *</span></label>
                           <textarea class="form-control" name="bio" maxlength="200"></textarea>
                        </div>
                     </div>
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12  ">
                        <div class="form-group">
                           <label>Destination<span class="text-danger"> *</span></label>
                           <select data-placeholder="Select 3 Destination" multiple class="chosen-select form-control w-100" name="destination[]" id="destination">
                           @foreach ($destination as $destinations)
                              <option class="bg-info" value="{{ $destinations->id }}" disabled>{{ $destinations->country_name }}</option>
                              @foreach($destinations->city as $cities)
                     ...
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12 " id="second">
                        <div class="form-group">
                           <label>Interest<span class="text-danger"> *</span></label>
                           <select data-placeholder="Select 3 Destination" multiple class="chosen-select form-control w-100" name="interest[]" id="interest">
                              @foreach ($interestcategory as $interestcat)
                              <option class="bg-info" value="{{ $interestcat->id }}" disabled>{{ $interestcat->name }}</option>
                              @foreach($interestcat->interest as $interest)
                     ...
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="subscription_plan">
                              ...
                              @forelse($subscription_plan as $subscription_plans)
                              <option value="{{ $subscription_plans->id }}">{{ $subscription_plans->plan_name }} (Plan Duration: {{ $subscription_plans->plan_duration }} Months) (Plan Price($): {{ $subscription_plans->plan_price }})</option>
                              @empty
 ...
 <div class="form-group mt-4">
                <label for="p_name">  User Images</label>
                <div id="dropzoneDragArea"   class="dz-default dz-message dropzoneDragArea">
                  ...
                  <span class="customsvg">Upload 10  Images</span>
                  <!-- <input type="file"  accept="image/*" name="multiple_images[]" id="multiple_images" class="">  -->
                </div>
...
skin_color:{
required : "Please select skin color",
},
body_type:{
...
rangelength : " Please enter bio 20 to 200  characters long"  
},
'destination[]':{
   required:"Please select destination",
   minlength:"Select 3 destinations"
},
'interest[]':{
   required:"Please select interest",
   minlength:"Select 3 interests"
},
...
$(".remove-pro-img").click(function(evt){      
  ...
  $(document).ready(function(){
    $('[name=tags]').tagify({
      duplicates :false,
      delimiters: ",",
      whitelist: ['aaRealme','aaNokia','aaSumsung'],
...
success: (data) => {
         if(data == "success"){
            ...
            $('.image_notice').html('');
            localStorage.setItem('success_data', 'User Created Successfully');
...
$(document).on('change', '#category', function() {
    ...
    $.ajax({
        type: 'POST',
        url: "{{route('interest_category_type')}}",
        data: {
            id: id,
        },
        dataType: "json",
        success: function(response) {
            ...
            console.log(response.length);
             ...
             var html = '<option value="" disabled="" selected>Select value</option>';
  ...
  sort: true,
           ...
           var $selectEventTypeAssetId = $('<select id="interest" class="form-control" />').appendTo('.alertTypeMultipleSelect');
$selectEventTypeAssetId.append(html);
