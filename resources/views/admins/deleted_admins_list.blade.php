                  ...
                  <tr>
                    ...
                    @if(Gate::check('restore_admin') || Gate::check('permanent_deleted_admin')) 
                      ...
                      <td>
                        ...
                        <a class="action-button restore-button" title="Restore" href="javascript:void(0)"  data-id="{{$adminsList[$i]->id}}"><i class="text-success fa fa-undo"></i></a>
                        @endcan
                        ...
                        @can('permanent_deleted_admin')
                        <a class="action-button delete-button" title=" Permanent Delete" href="javascript:void(0)" data-id="{{$adminsList[$i]->id}}"><i class="text-danger fa fa-trash-alt"></i></a>
