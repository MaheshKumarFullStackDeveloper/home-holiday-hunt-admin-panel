      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               ...
               @endif
               <form id="addDestinationForm" autocomplete="off" method="post", action="{{ route('save_destination') }}" onload="myFunction()" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                     <div class="row">
                   ...
                   <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
                        <div class="profile-image-show mt-3">
                           ...
                           <div class="thumb_nails  ">
                              ...
                              <h4>Add Destination Image</h4>
                           </div>
                           <input type="file"   name="dest_image" id="dest_image" class="">  
                        </div>
                     </div>
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" name="name" class="form-control" id="name" maxlength="100" placeholder="Search Destinaion..">
                           </div>
                        </div>
                        <div class="col-md-12">
                           <div class="form-group">
                              <label for="name">City<span class="text-danger"> *</span></label>
                              <input type="text" name="txtCity" class="form-control" id="txtCity" maxlength="100" readonly>
                        </div>

                        <div class="col-md-12">
                           <div class="form-group">
                              <label for="name">Country<span class="text-danger"> *</span></label>
                              <input type="text" name="txtCountry" class="form-control" id="txtCountry" maxlength="100" readonly>
                        </div>

                     
                            
              
                              <input type="hidden" name="state" class="form-control" id="txtState" maxlength="100">
                      
            
                              <input type="hidden" name="zipcode" class="form-control" id="txtZip" maxlength="100">
                         
<!--                          <div class="col-md-6">
                           <div class="form-group">
                              <label for="name">Latitude<span class="text-danger"> *</span></label> -->
                              <input type="hidden" name="lat" class="form-control" id="lat" readonly>
                           <!-- </div>
                        </div> -->
                      <!--   <div class="col-md-6">
                           <div class="form-group"> -->
                          <!--     <label for="name">Longitude<span class="text-danger"> *</span></label> -->
                              <input type="hidden" name="lng" class="form-control" id="lng" readonly>
                           <!-- </div>
                        </div> -->
                ...
                if (status == google.maps.GeocoderStatus.OK) {
                    if (results[0]) {
                        ...
                        $.ajax({
                         ...
                         type:'POST',
                         data: {_token:"{{ csrf_token() }}", name:city, country_name:country},
                         success: function(data) {
                            if(data.msg==1){
                              $("#name").after('<label for="name" generated="true" class="error">The Destination is already existed, Please try another one.</label>');
...
dest_image: {required: true, accept: "jpg,jpeg,png,gif"}
